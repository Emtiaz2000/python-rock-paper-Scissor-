...
game_elements=["rock",'paper','scissure']#list
...
if user_input == 'rock' or user_input == 'paper' or user_input == 'scissure':
    #user entered the entered right word
    if user_input == game_elements[computer_pick]:
        print("Draw!")
        print(game_elements[computer_pick] )
        print(user_input )
    elif user_input == "scissure" and game_elements[computer_pick] =='rock':
        print('OOps you loss!')
        print(game_elements[computer_pick] )
    elif user_input == "rock" and game_elements[computer_pick] =='paper':
        print('OOps you loss!')
        print(game_elements[computer_pick] )
    elif user_input == "paper" and game_elements[computer_pick] =='scissure':
        print('OOps you loss!')
        print(game_elements[computer_pick] )
    else:
        print('You win!')
